package com.giz.android.practice.hencoder.hencoderpracticedraw2;
...
public class HenCoderPracticeDraw2MainActivity extends AppCompatActivity {
    TabLayout tabLayout;
    ViewPager pager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hencoder_practicedraw2_main);
        ...
        pager.setAdapter(new FragmentPagerAdapter(getSupportFragmentManager()) {
            ...
            public Fragment getItem(int position) {
                ...
                return HenCoderPracticeDraw2PageFragment.newInstance(pageModel.sampleLayoutRes, pageModel.practiceLayoutRes);
            }
