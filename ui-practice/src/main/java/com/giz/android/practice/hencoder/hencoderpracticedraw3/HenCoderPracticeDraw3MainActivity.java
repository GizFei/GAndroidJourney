...
public class HenCoderPracticeDraw3MainActivity extends AppCompatActivity {
    TabLayout tabLayout;
    ViewPager pager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hencoder_practicedraw3_main);
        ...
        pager.setAdapter(new FragmentPagerAdapter(getSupportFragmentManager()) {
            ...
            public Fragment getItem(int position) {
                ...
                return HenCoderPracticeDraw3PageFragment.newInstance(pageModel.sampleLayoutRes, pageModel.practiceLayoutRes);
            }
