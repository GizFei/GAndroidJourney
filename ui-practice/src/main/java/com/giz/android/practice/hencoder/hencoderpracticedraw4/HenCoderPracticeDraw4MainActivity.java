...
public class HenCoderPracticeDraw4MainActivity extends AppCompatActivity {
    TabLayout tabLayout;
    ViewPager pager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hencoder_practicedraw4_main);
        ...
        pager.setAdapter(new FragmentPagerAdapter(getSupportFragmentManager()) {
            ...
            public Fragment getItem(int position) {
                ...
                return HenCoderPracticeDraw4PageFragment.newInstance(pageModel.sampleLayoutRes, pageModel.practiceLayoutRes);
            }
